...
public class EntitySetMetadata implements Packet<IPlayHandlerClientbound> {

    private int entityId;
    private EntityMetadata metadata;

    public EntitySetMetadata() {
    }

    public EntitySetMetadata(int entityId, EntityMetadata metadata) {
