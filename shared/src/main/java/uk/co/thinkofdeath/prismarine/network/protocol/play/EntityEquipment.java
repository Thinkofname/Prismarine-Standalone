...
public class EntityEquipment implements Packet<IPlayHandlerClientbound> {
    ...
    public EntityEquipment(int entityId, int slot, ItemStack itemStack) {
        this.entityId = entityId;
        this.slot = slot;
        this.itemStack = itemStack.duplicate();
    }
