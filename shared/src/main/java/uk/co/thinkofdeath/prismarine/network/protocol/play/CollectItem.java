...
public class CollectItem implements Packet<IPlayHandlerClientbound> {
    ...
    public CollectItem(int collectedId, int collectorId) {
    ...
    public void read(MCByteBuf buf) {
        collectedId = buf.readVarInt();
        collectorId = buf.readVarInt();
    }
